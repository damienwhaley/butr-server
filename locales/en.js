{
	...
	"I don't know what this command is!": "I don't know what this command is!",
	"I don't know what the %s command is!": "I don't know what the %s command is!",
	"WARNING": "WARNING",
	"Could not change to requested language, so using %s instead.": "Could not change to requested language, so using %s instead.",
	...
	"Butr v%s with pid %s has started and is listening on %s://%s:%s": "Butr v%s with pid %s has started and is listening on %s://%s:%s"
}