...
function convert(snippetJson) {
  ...
  if (snippetJson.language !== undefined && snippetJson.language !== null && typeof(snippetJson.language) === 'string') {
    snippetInternal.language = snippetJson.language;
  }
  else {
    snippetInternal.language = '';
  }
