...
function convert(snippetJson) {
  ...
  if (snippetJson.client_type !== undefined
    && snippetJson.client_type !== null
    && typeof(snippetJson.client_type) === 'string') {
	snippetInternal.client_type = snippetJson.client_type;
  }
  else {
	snippetInternal.client_type = '';
  }
  
  if (snippetInternal.client_type === '') {
	// Invalid message
	return null;
  }
