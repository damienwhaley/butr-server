...
function convert(snippetJson) {
  ...
  if (snippetJson.offset !== undefined && snippetJson.offset !== null && !isNaN(snippetJson.offset)) {
  ...
  if (snippetJson.size !== undefined && snippetJson.size !== null && !isNaN(snippetJson.size)) {
  ...
  if (snippetJson.ordinal !== undefined && snippetJson.ordinal !== null && typeof(snippetJson.ordinal) === 'string') {
  ...
  if (snippetJson.direction !== undefined && snippetJson.direction !== null && typeof(snippetJson.direction) === 'string') {
