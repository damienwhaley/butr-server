...
function convert(snippetJson) {
  ...
  if (snippetJson.uuid !== undefined && snippetJson.uuid !== null && typeof(snippetJson.uuid) === 'string') {
    ...
    snippetInternal.group_name = '';
  }
  
  if (snippetJson.group_name !== undefined && snippetJson.group_name !== null && typeof(snippetJson.group_name) === 'string') {
    snippetInternal.group_name = snippetJson.group_name;
  }
  else {
    snippetInternal.group_name = '';
  }
  ...
  if (snippetInternal.group_name === '' || snippetInternal.uuid === '') {
	// Invalid message
	return null;
  }
