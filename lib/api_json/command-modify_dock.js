...
function convert(snippetJson) {
  ...
  if (snippetJson.dock_name !== undefined && snippetJson.dock_name !== null && typeof(snippetJson.dock_name) === 'string') {
    snippetInternal.dock_name = snippetJson.dock_name;
  }
  else {
    snippetInternal.dock_name = '';
  }
  ...
  if (snippetInternal.dock_name === '' || snippetInternal.security_client_type_uuid === ''
	|| snippetInternal.uuid === '') {
	// Invalid message
	return null;
  }
