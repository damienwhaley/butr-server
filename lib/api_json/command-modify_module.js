...
function convert(snippetJson) {
  ...
  if (snippetJson.module_name !== undefined
	&& snippetJson.module_name !== null
	&& typeof(snippetJson.module_name) === 'string') {
    snippetInternal.module_name = snippetJson.module_name;
  }
  else {
    snippetInternal.module_name = '';
  }
  ...
  if (snippetInternal.message_name === ''
	|| snippetInternal.magic === ''
	|| snippetInternal.uuid === '') {
	// Invalid message
	return null;
