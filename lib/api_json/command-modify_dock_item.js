...
function convert(snippetJson) {
  ...
  if (snippetJson.dock_uuid !== undefined && snippetJson.dock_uuid !== null && typeof(snippetJson.dock_uuid) === 'string') {
    snippetInternal.dock_uuid = snippetJson.dock_uuid;
  }
  else {
    snippetInternal.dock_uuid = '';
  }
  ...
  if (snippetJson.item_name !== undefined && snippetJson.item_name !== null && typeof(snippetJson.item_name) === 'string') {
    snippetInternal.item_name = snippetJson.item_name;
  }
  else {
    snippetInternal.item_name = '';
  }
  ...
  if (snippetJson.item_action !== undefined && snippetJson.item_action !== null && typeof(snippetJson.item_action) === 'string') {
    snippetInternal.item_action = snippetJson.item_action;
  }
  else {
    snippetInternal.item_action = '';
  }
  ...
  if (snippetInternal.item_name === '' || snippetInternal.system_dock_type_uuid === ''
	|| snippetInternal.security_client_type_uuid === '' || snippetInternal.dock_uuid === ''
	|| snippetInternal.uuid === '') {
	// Invalid message
	return null;
  }
