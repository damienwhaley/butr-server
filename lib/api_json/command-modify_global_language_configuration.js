...
function convert(snippetJson) {
  ...
  if (snippetJson.language_code !== undefined && snippetJson.language_code !== null && typeof(snippetJson.language_code) === 'string') {
    snippetInternal.language_code = snippetJson.language_code;
  }
  else {
    snippetInternal.language_code = '';
  }
  
  if (snippetJson.language_family !== undefined && snippetJson.language_family !== null && typeof(snippetJson.language_family) === 'string') {
    snippetInternal.language_family = snippetJson.language_family;
  }
  else {
    snippetInternal.language_family = '';
  }
  
  if (snippetJson.country_uuid !== undefined && snippetJson.country_uuid !== null && typeof(snippetJson.country_uuid) === 'string') {
    snippetInternal.country_uuid = snippetJson.country_uuid;
  }
  else {
    snippetInternal.country_uuid = '';
  }
  ...
  if (snippetInternal.language_code === '' || snippetInternal.country_uuid === ''
	|| snippetInternal.name_label === '' || snippetInternal.uuid === '') {
	// Invalid message
	return null;
  }
