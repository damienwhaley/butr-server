...
function convert(snippetJson) {
  ...
  if (snippetJson.table_name !== undefined
	&& snippetJson.table_name !== null
	&& typeof(snippetJson.table_name) === 'string') {
    snippetInternal.table_name = snippetJson.table_name;
  }
  else {
    snippetInternal.table_name = '';
  }
  
  if (snippetInternal.table_name === '') {
	// Invalid message
	return null;
  }
