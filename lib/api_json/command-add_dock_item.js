...
function convert(snippetJson) {
  ...
  if (snippetJson.dock_uuid !== undefined
	&& snippetJson.dock_uuid !== null
	&& typeof(snippetJson.dock_uuid) === 'string') {
  ...
  if (snippetJson.item_name !== undefined
	&& snippetJson.item_name !== null
	&& typeof(snippetJson.item_name) === 'string') {
  ...
  if (snippetJson.item_action !== undefined
	&& snippetJson.item_action !== null
	&& typeof(snippetJson.item_action) === 'string') {
