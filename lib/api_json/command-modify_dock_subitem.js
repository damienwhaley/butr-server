...
function convert(snippetJson) {
  ...
  if (snippetJson.dock_item_uuid !== undefined
	&& snippetJson.dock_item_uuid !== null
	&& typeof(snippetJson.dock_item_uuid) === 'string') {
  ...
  if (snippetJson.subitem_name !== undefined
	&& snippetJson.subitem_name !== null
	&& typeof(snippetJson.subitem_name) === 'string') {
  ...
  if (snippetJson.subitem_action !== undefined
	&& snippetJson.subitem_action !== null
	&& typeof(snippetJson.subitem_action) === 'string') {
