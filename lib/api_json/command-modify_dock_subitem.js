...
function convert(snippetJson) {
  ...
  if (snippetJson.dock_item_uuid !== undefined && snippetJson.dock_item_uuid !== null && typeof(snippetJson.dock_item_uuid) === 'string') {
    snippetInternal.dock_item_uuid = snippetJson.dock_item_uuid;
  }
  else {
    snippetInternal.dock_item_uuid = '';
  }
  
  if (snippetJson.system_dock_type_uuid !== undefined && snippetJson.system_dock_type_uuid !== null && typeof(snippetJson.system_dock_type_uuid) === 'string') {
  ...
  if (snippetJson.security_client_type_uuid !== undefined && snippetJson.security_client_type_uuid !== null && typeof(snippetJson.security_client_type_uuid) === 'string') {
  ...
  if (snippetJson.subitem_name !== undefined && snippetJson.subitem_name !== null && typeof(snippetJson.subitem_name) === 'string') {
    snippetInternal.subitem_name = snippetJson.subitem_name;
  }
  else {
    snippetInternal.subitem_name = '';
  }
  ...
  if (snippetJson.icon !== undefined && snippetJson.icon !== null && typeof(snippetJson.icon) === 'string') {
    snippetInternal.icon = snippetJson.icon;
  }
  else {
    snippetInternal.icon = '';
  }
  
  if (snippetJson.subitem_action !== undefined && snippetJson.subitem_action !== null && typeof(snippetJson.subitem_action) === 'string') {
    snippetInternal.subitem_action = snippetJson.subitem_action;
  }
  else {
    snippetInternal.subitem_action = '';
  }
  ...
  if (snippetInternal.subitem_name === '' || snippetInternal.system_dock_type_uuid === ''
	|| snippetInternal.security_client_type_uuid === '' || snippetInternal.dock_item_uuid === ''
	|| snippetInternal.uuid === '') {
	// Invalid message
	return null;
  }
