...
function convert(snippetJson) {
  ...
  if (snippetJson.dock_subitem_uuid !== undefined && snippetJson.dock_subitem_uuid !== null && typeof(snippetJson.dock_subitem_uuid) === 'string') {
  ...
  if (snippetJson.tab_name !== undefined && snippetJson.tab_name !== null && typeof(snippetJson.tab_name) === 'string') {
  ...
  if (snippetJson.tab_action !== undefined && snippetJson.tab_action !== null && typeof(snippetJson.tab_action) === 'string') {
  ...
  if (snippetInternal.subitem_name === '' || snippetInternal.system_dock_type_uuid === ''
	|| snippetInternal.security_client_type_uuid === '' || snippetInternal.uuid === ''
	|| (snippetInternal.dock_item_uuid === '' && snippetInternal.dock_subitem_uuid)) {
	// Invalid message
	return null;
  }
