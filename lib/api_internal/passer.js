...
function passMessage(res, metaJson, messageName, canExecute, messageFormat, messageInternal, sessionData) {
  ...
  case 'add_dock_subtab':
	var butrApiInternalCommandAddDockSubtab = require('./command-add_dock_subtab');
	butrApiInternalCommandAddDockSubtab.execute(res, metaJson, messageFormat, messageInternal, sessionData);
	break;
  case 'add_dock_tab':
  ...
  case 'fetch_dock_subtab':
	var butrApiInternalCommandFetchDockSubtab = require('./command-fetch_dock_subtab');
	butrApiInternalCommandFetchDockSubtab.execute(res, metaJson, messageFormat, messageInternal, sessionData);
	break;
  case 'fetch_dock_tab':
  ...
  case 'list_dock_subtabs':
	var butrApiInternalCommandListDockSubtabs = require('./command-list_dock_subtabs');
	butrApiInternalCommandListDockSubtabs.execute(res, metaJson, messageFormat, messageInternal, sessionData);
	break;
  case 'list_dock_tabs':
  ...
  case 'modify_dock_subtab':
	var butrApiInternalCommandModifyDockSubtab = require('./command-modify_dock_subtab');
	butrApiInternalCommandModifyDockSubtab.execute(res, metaJson, messageFormat, messageInternal, sessionData);
	break;
  ...
  case 'remove_dock_subtab':
	var butrApiInternalCommandRemoveDockSubtab = require('./command-remove_dock_subtab');
	butrApiInternalCommandRemoveDockSubtab.execute(res, metaJson, messageFormat, messageInternal, sessionData);
	break;
