...
function execute(res, metaJson, messageFormat, messageInternal, sessionData) {
  ...
  var sqlString = sqlModifyDockSubitem(sessionUuid,
	...
	messageInternal.weighting, messageInternal.picture_path, messageInternal.subitem_action,
 ...
 * @param picturePath
 *   - String containing the address of the picture_path for the dock.
 * @param subitemAction
...
function sqlModifyDockSubitem(sessionUuid, transactionUuid, tableUuid, dockItemUuid, systemDockTypeUuid,
  securityClientTypeUuid, subitemName, displayName, description, weighting, picturePath,
