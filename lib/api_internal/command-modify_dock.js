...
function execute(res, metaJson, messageFormat, messageInternal, sessionData) {
  ...
  var sqlString = sqlModifyDock(sessionUuid, transactionUuid, messageInternal.uuid,
	messageInternal.security_client_type_uuid, messageInternal.dock_name,
	messageInternal.display_name, messageInternal.description, messageInternal.weighting,
	messageInternal.picture_path, messageInternal.is_active);
 ...
 * @api private
 */
function sqlModifyDock(sessionUuid, transactionUuid, tableUuid, securityClientTypeUuid,
  dockName, displayName, description, weighting, picturePath, isActive) {
  'use strict';
