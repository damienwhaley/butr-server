    ...
    if (jsonResult !== undefined && jsonResult !== null && typeof(jsonResult) === 'object') {
      ...
      if (jsonResult.rows.length > 0) {
        ...
        if (jsonResult.rows[0].dock_item_uuid !== undefined
	      ...
	      outJson.fetch_dock_tab.dock_item_uuid = jsonResult.rows[0].dock_item_uuid;
        }
	    else {
	      outJson.fetch_dock_tab.dock_item_uuid = '';
	    }
        
        if (jsonResult.rows[0].dock_item_name !== undefined
          && jsonResult.rows[0].dock_item_name !== null
          && jsonResult.rows[0].dock_item_name !== '') {
          outJson.fetch_dock_tab.dock_item_name = jsonResult.rows[0].dock_item_name;
        }
        else {
          outJson.fetch_dock_tab.dock_item_name = '';
        }
        ...
        if (jsonResult.rows[0].dock_item_display_name !== undefined
          ...
          outJson.fetch_dock_tab.dock_item_display_name = jsonResult.rows[0].dock_item_display_name;
        }
        else {
          outJson.fetch_dock_tab.dock_item_display_name = '';
        }
        
        if (jsonResult.rows[0].dock_subitem_uuid !== undefined
  	      && jsonResult.rows[0].dock_subitem_uuid !== null
  	      && jsonResult.rows[0].dock_subitem_uuid !== '') {
  	      outJson.fetch_dock_tab.dock_subitem_uuid = jsonResult.rows[0].dock_subitem_uuid;
          }
  	    else {
  	      outJson.fetch_dock_tab.dock_subitem_uuid = '';
  	    }
          
        if (jsonResult.rows[0].dock_subitem_name !== undefined
          && jsonResult.rows[0].dock_subitem_name !== null
          && jsonResult.rows[0].dock_subitem_name !== '') {
          outJson.fetch_dock_tab.dock_subitem_name = jsonResult.rows[0].dock_subitem_name;
        }
        else {
          outJson.fetch_dock_tab.dock_subitem_name = '';
        }
        
        if (jsonResult.rows[0].dock_subitem_display_name !== undefined
          && jsonResult.rows[0].dock_subitem_display_name !== null
          && jsonResult.rows[0].dock_subitem_display_name !== '') {
          outJson.fetch_dock_tab.dock_subitem_display_name = jsonResult.rows[0].dock_subitem_display_name;
        }
        else {
          outJson.fetch_dock_tab.dock_subitem_display_name = '';
        }
        ...
        if (jsonResult.rows[0].icon !== undefined
          ...
          outJson.fetch_dock_tab.icon = jsonResult.rows[0].icon;
        }
        else {
          outJson.fetch_dock_tab.icon = '';
        }
