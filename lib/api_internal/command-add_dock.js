...
function execute(res, metaJson, messageFormat, messageInternal, sessionData) {
  ...
  var sqlString = sqlAddDock(sessionUuid, transactionUuid,
    ...
    messageInternal.weighting, messageInternal.picture_path, messageInternal.is_active);
 ...
 * @api private
 */
function sqlAddDock(sessionUuid, transactionUuid, securityClientTypeUuid, dockName,
  displayName, description, weighting, picturePath, isActive) {
  'use strict';
